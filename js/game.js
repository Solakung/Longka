...
const SPR_SIZE={ warrior:32, brahmin:32, vanara:32, rishi:32, bibhek:32, garuda:32, boss:32, yaksha:32, golem:32, berserker:32, singha:32, makara:32, bat:32, scorpion:32, shaman:32, chameleon:32, kamikaze:32, spider:32, kinnara:32, wraith:32, peacock:32, preta:32, asura:32, naga:32, rakshasa:32, vetala:32 };
const SPRD={
"warrior": [
  "..............gggg..............",
  ".............gggggg.............",
  ...
  ".........ggggggffgggggg.........",
  ".......ggggggggffgggggggg.......",
  ".....ggggggksssssssskgggggg.....",
  "....ggggssssssshhsssssssgggg....",
  "....gggsssssshhsshhssssssggg....",
  "....gggssssss10ss01ssssssggg....",
  "....gggssssssnssssnssssssggg....",
  "....gggsssssnnssssnnsssssggg....",
  "....gggsssssxssssssxsssssggg....",
  ".....ggssssssssssssssssssgg.....",
  "......ssssssssssssssssssss......",
  ".......ssssssssssssssssss.......",
  "......kksssssssssssssssskk......",
  "..ggggggrrrrrrrrrrrrrrrrgggggg..",
  ".ggggggrrrrrrrrrrrrrrrrrrgggggg.",
  "gggggrrrrrrrrrrrrrrrrrrrrrrggggg",
  "ggggrrrrrrrrrrrrrrrrrrrrrrrrgggg",
  "gggrrrrryrrrrrrrrrrrrrryrrrrrggg",
  "gggrrrrrrrrrrrrrrrrrrrrrrrrrrggg",
  "ggddddddddddddddddddddddddddddgg",
  "gdddddddddddddyyyydddddddddddddg",
  ".dddddddddddddddddddddddddddddd.",
  "..ddddddrrrrrrrrrrrrrrrrdddddd..",
...
"brahmin": [
  ...
  ".....wwwssssssshhssssssswww.....",
  ".....wwsssssshhsshhssssssww.....",
  ".....wwsssss10ssss01sssssww.....",
  ".....wwssssssnssssnssssssww.....",
  ".....wwsssssnnssssnnsssssww.....",
  ".....wwsssssxssssssxsssssww.....",
  "......wssssssssssssssssssw......",
  ".......ssssssssssssssssss.......",
  "........ssssssssssssssss........",
  ".......wwssssssssssssssww.......",
  "....wwwwwowwwwwwwwwwwwowwwww....",
  "..wwwwwwwwwwwwwwwwwwwwwwwwwwww..",
  "wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww",
  "wwwwwwwoowwwwwwwwwwwwwwoowwwwwww",
  "wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww",
  "wwwwwoowwwwwwwwwwwwwwwwwwoowwwww",
  "wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww",
  "ddwwwwwwwwwwwwddddwwwwwwwwwwwwdd",
  "wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww",
  "wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww",
...
"vanara": [
  ...
  "...wwwwwwwwwwwwwwwwwwwwwwwwww...",
  "...wwwwwwwwwwwwwwwwwwwwwwwwww...",
  "...wwkkkkkkkkkwwwwkkkkkkkkkww...",
  "...wwkkk10kkkwwwwwwkkk01kkkww...",
  "...wwkkkkkkkkkwwwwkkkkkkkkkww...",
  "...wwwwwwwwwwwwwwwwwwwwwwwwww...",
  "....wwwwwwwwwwwwwwwwwwwwwwww....",
  "....wwwwwxwwwwwwwwwwwwxwwwww....",
  ...
  "gggyggggggggggggggggggggggggyggg",
  "gggggggggggggggggggggggggggggggg",
  "ggddddddddddddddddddddddddddddgg",
  ".dddddddddddddddddddddddddddddd.",
  "..dddddwwwwwwwwwwwwwwwwwwddddd..",
  "..dddddwwwwwwwwwwwwwwwwwwddddd..",
...
"rishi": [
  ...
  ".kkkksssssssssssssssssssssskkkk.",
  ".kkkkkssssssssshhssssssssskkkkk.",
  ".kkkkkssssssshhsshhssssssskkkkk.",
  ".kkkkkssssss10ssss01sssssskkkkk.",
  ".kkkkksssssssnssssnssssssskkkkk.",
  ".kkkkksssssnnssssssnnssssskkkkk.",
  ".kkkkksssssxssssssssxssssskkkkk.",
  ".kkkkksskkkkkksssskkkkkksskkkkk.",
  "..kkkkkkkkkkkkkkkkkkkkkkkkkkkk..",
  "...kkkkkkkkkkkkkkkkkkkkkkkkkk...",
  "....ssssssssssssssssssssssss....",
  "...kkooooooooooooooooooooookk...",
  ".kkkkooooooooooooooooooooookkkk.",
  "kkooooooooooooooooooooooooooookk",
  "oooooooooooooooooooooooooooooooo",
  "ooofoooooooooooooooooooooooofooo",
  "oooooooooooooooooooooooooooooooo",
  "ooddddddddddddooooddddddddddddoo",
  "oooooooooooooooooooooooooooooooo",
  "oooooooooooooooooooooooooooooooo",
...
"preta": [
    ...
    "....EEEEEEEEEEEEEEEEEEEEEEEE....",
    "...EEEEEEEEEEEEEEEEEEEEEEEEEE...",
    "..EE..EEEEEEEEEEEEEEEEEEEE..EE..",
    ".EEE...EEEEEEEEEEEEEEEEEE...EEE.",
    "......EEEEEEEEEEEEEEEEEEEE......",
    ".....EEEEEEEEEEEEEEEEEEEEEE.....",
    "....EEEEEEEEEEEEEEEEEEEEEEEE....",
    ".....EEEEEEEEEEEEEEEEEEEEEE.....",
...
"asura": [
    ...
    "rrrggrrrrrrrrrrrrrrrrrrrrrrggrrr",
    "rrrgg0rrrrrrrrrrrrrrrrrrrr0ggrrr",
    "rrrggrrrrrrrrrrrrrrrrrrrrrrggrrr",
    "rrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr",
    "rrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr",
...
"naga": [
    ...
    ".ggttttttttttttttttttttttttttgg.",
    ".ggttt0tttttttttttttttttt0tttgg.",
    ".ggttttttttttttttttttttttttttgg.",
    "..tttttttttttttttttttttttttttt..",
    "...tttttttttttttttttttttttttt...",
...
"rakshasa": [
    ...
    "pppggppppppppppppppppppppppggppp",
    "pppgg0pppppppppppppppppppp0ggppp",
    "pppggppppppppppppppppppppppggppp",
    "pppwwwwwwwwwwppppppwwwwwwwwwwppp",
    "pppwwwwwwwwwwppppppwwwwwwwwwwppp",
    "pppppppppppppppppppppppppppppppp",
    "pppppppppppppppppppppppppppppppp",
    "pppppppppppppppppppppppppppppppp",
    "pp.pppppppppppppppppppppppppp.pp",
    ".pppppppppppppppppppppppppppppp.",
    "..pppppppppppppppppppppppppppp..",
    "..pppppppppppppppppppppppppppp..",
...
"yaksha": [
  ...
  "gggggggggggggggggggggggggggggggg",
  "ddeeeeeeeeeeeeddddeeeeeeeeeeeedd",
  "ddeeeeeheeheeeeeeeeeeheeheeeeedd",
  "ddeeee0eeee0eeeeeeee0eeee0eeeedd",
  "ddeeeeeeeeeeeeddddeeeeeeeeeeeedd",
  "ddeeeeeeneeeeeddddeeeeeneeeeeedd",
  "ddeeeeeweeweeeddddeeeweeweeeeedd",
  "dddeeeeeeeeeeddddddeeeeeeeeeeddd",
  "ddddeeeeeeeeddddddddeeeeeeeedddd",
  "dddddeeeeeeddddddddddeeeeeeddddd",
  "ddddddkkkkddddddddddddkkkkdddddd",
  "ddggggggrrrrrrrrrrrrrrrrggggggdd",
  "dggggggrrrrrrrrrrrrrrrrrrggggggd",
  "ggggrrrrrrrrrrrrrrrrrrrrrrrrgggg",
  "gggrrrrrrrrrrrrrrrrrrrrrrrrrrggg",
  "ggrrrrrryyrrrrrrrrrrrryyrrrrrrgg",
...
"boss": [
  ...
  "gggggggggggggggggggggggggggggggg",
  "gggeeggggggeeggggggeeggggggeeggg",
  "gggggggggggggggggggggggggggggggg",
  ".ggeeeeeeeeeeeeeeeeeeeeeeeeeegg.",
  ".ggeeeeekkkkeeeeeeeekkkkeeeeegg.",
  "..geeeee0e0eeeeeeeeee0e0eeeeeg..",
  "..geeeeeeeeeeeeeeeeeeeeeeeeeeg..",
  "..geeeeeeneeeeeeeeeeeeneeeeeeg..",
  "..geeeeeweeweeeeeeeeweeweeeeeg..",
  "...geeeeeeeeeeeeeeeeeeeeeeeeg...",
  "....eeeeeeeeeeeeeeeeeeeeeeee....",
  ".....kkeeeeeeeeeeeeeeeeeekk.....",
  "..ggggggrrrrrrrrrrrrrrrrgggggg..",
  ".ggggggrrrrrrrrrrrrrrrrrrgggggg.",
  "gggggrrrrrrrrrrrrrrrrrrrrrrggggg",
  "ggggrrrrrrrrrryyyyrrrrrrrrrrgggg",
  "gggrrrrrrrrrrrrrrrrrrrrrrrrrrggg",
  "ggddddddddddddddddddddddddddddgg",
  "gdddddddddddddyyyydddddddddddddg",
  ".dddddddddddddddddddddddddddddd.",
...
"scr": [
  ...
  "...gggggggggggggggggggggggggg...",
  "..gggggggggggeeeeeeggggggggggg..",
  "......ggggssssssssssssgggg......",
  ".....gggssssssshhsssssssggg.....",
  ".....ggsssssshhsshhssssssgg.....",
  ".....ggsssss10ssss01sssssgg.....",
  ".....ggssssssnssssnssssssgg.....",
  ".....ggsssssnnssssnnsssssgg.....",
  ".....ggsssssxssssssxsssssgg.....",
  "......gssssssssssssssssssg......",
  ".......ssssssssssssssssss.......",
  "........ssssssssssssssss........",
  ".......ggssssssssssssssgg.......",
  "....gggggeggggggggggggeggggg....",
  "..gggggggggggggggggggggggggggg..",
  "gggggggggggggggggggggggggggggggg",
  "gggggggeeggggggggggggggeeggggggg",
  "wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww",
  "wwwwwffwwwwwwwwwwwwwwwwwwffwwwww",
  "wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww",
  "eewwwwwwwwwwwweeeewwwwwwwwwwwwee",
  "wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww",
  "wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww",
  ".wwwwwwwwwwwwwwwwwwwwwwwwwwwwww.",
  "..wwwwwwwwwwwwwwwwwwwwwwwwwwww..",
  "...wwwwwwwwwwwwwwwwwwwwwwwwww...",
  "...eeeewwwwwwwwwwwwwwwwwweeee...",
  "....gggggggggggggggggggggggg....",
  ...
  "...ggggg................ggggg...",
  "..ggggggg..............ggggggg..",
  ".ggooooooooooggggggoooooooooogg.",
  ".ggooook0koooggggggoook0koooogg.",
  ".ggooooooooooggggggoooooooooogg.",
  "..gggooooooooggggggooooooooggg..",
  "...ggggooooooggggggoooooogggg...",
  "....gggggooooggggggooooggggg....",
  ".....gggggggggggggggggggggg.....",
  "....ffffffffffffffffffffffff....",
  "...ffffooooooooooooooooooffff...",
  "..ffffffooooooooooooooooffffff..",
  ".ffffffffooooooooooooooffffffff.",
  "fffoooooooooooooooooooooooooofff",
  "ffooooooooooooooooooooooooooooff",
  "oooooooooooooooooooooooooooooooo",
  "ooooogoooooooooooooooooooogooooo",
  "oooooooooooooooooooooooooooooooo",
  "oooooooooooooooooooooooooooooooo",
  "oooffooooooooooooooooooooooffooo",
  "oooooooooooooooooooooooooooooooo",
  "oooooooooooooooooooooooooooooooo",
  ".oooooooooooooooooooooooooooooo.",
...
,
  ...
  ".krrrrrrrkrrrrrrrrrrrrkrrrrrrrk.",
  "krrrrrrrrkrrrrrrrrrrrrkrrrrrrrrk",
  "kkrrrrrrkrrrrrrrrrrrrrrkrrrrrrkk",
  ".krrrrrrrkrrrrrrrrrrrrkrrrrrrrk.",
  ...
  "..rrrrrr0rrrrr....rrrrr0rrrrrr..",
  ".dddddddddddddddddddddddddddddd.",
  ".dddddnddddddddddddddddddnddddd.",
  "dd......dd............dd......dd",
  "dd......dd............dd......dd",
  "................................",
  "................................",
  ...
  "pppffffffffffppppppffffffffffppp",
  "ppffffffffffff....ffffffffffffpp",
  "..fffssssssfff....fffssssssfff..",
  "..ffsssshsssff....ffssshssssff..",
  "..ffssss10sssff..ffsss01ssssff..",
  "..fffssssssfff....fffssssssfff..",
  "pppssssssssssppppppssssssssssppp",
  "..ppptttppptttpppptttppptttppp..",
  "..pppppppppppp....pppppppppppp..",
  "...pppttttppp......pppttttppp...",
  "....pppppppp........pppppppp....",
  "....ttt..ttt........ttt..ttt....",
  "....ttt..ttt........ttt..ttt....",
  "................................",
  ...
  "dddddddddddddddddddddddddddddddd",
  "dddddddddddddddddddddddddddddddd",
  "ddddddttddddddddddddddddttdddddd",
  "ddddddttddddddddddddddddttdddddd",
  "dddddddddddddddddddddddddddddddd",
  "dddddddddddddddddddddddddddddddd",
  "ddddddkkkkddddddddddddkkkkdddddd",
  ...
  "dddddddddddddddddddddddddddddddd",
  "dddddddddddddddddddddddddddddddd",
  "dddEEEEddddddddddddddddddEEEEddd",
  "ddEEEEEEddddddddddddddddEEEEEEdd",
  "ddEttttEddddddddddddddddEttttEdd",
  "ddEttttEddddddddddddddddEttttEdd",
  "ddEEEEEEddddddddddddddddEEEEEEdd",
  "dddEEEEddddddddddddddddddEEEEddd",
  "dddddddddddddddddddddddddddddddd",
  ...
  "..eeeeeee0eeeeeeeeeeee0eeeeeee..",
  "..eeeeeeeeeeee....eeeeeeeeeeee..",
  ".eeeeeeeeeeeeee..eeeeeeeeeeeeee.",
  "eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee",
  "eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee",
  "eeetttttttttteeeeeetttttttttteee",
  "eeeetttttttteeeeeeeetttttttteeee",
  "eeeeetttttteeeeeeeeeetttttteeeee",
  "..eeeeeeeeeeee....eeeeeeeeeeee..",
  "...eeee..eeee......eeee..eeee...",
  "...eeee..eeee......eeee..eeee...",
  "....eee..eee........eee..eee....",
  ...
  "ooffffffffffffooooffffffffffffoo",
  "offf0fff................fff0fffo",
  "offffffffffffff..ffffffffffffffo",
  "offffffffffffff..ffffffffffffffo",
  "ooffffffffffffooooffffffffffffoo",
  "ooorrrrrrrrrroooooorrrrrrrrrrooo",
  "oorrrrrrrrrrrroooorrrrrrrrrrrroo",
  "..rrrrrryyrrrrrrrrrrrryyrrrrrr..",
  "..rrrrrrrrrrrr....rrrrrrrrrrrr..",
  "...rrrrrrrrrr......rrrrrrrrrr...",
  "....rrrrrrrr........rrrrrrrr....",
  ".....nn..nn..........nn..nn.....",
  ...
  "...kkkkkkkkkkkkkkkkkkkkkkkkkk...",
  "..kkkppppppppkkkkkkppppppppkkk..",
  "..kkppphpppkk......kkppphpppkk..",
  "kkpppp10ppppkk....kkpppp01ppppkk",
  "kkppppppppppppppppppppppppppppkk",
  ...
  ".fffsssssssssffffffsssssssssfff.",
  "..ffsssssssssffffffsssssssssff..",
  "..fssssshsssff....ffssshsssssf..",
  "..fsssss10sssff..ffsss01sssssf..",
  "..ffsssssssssffffffsssssssssff..",
  "...ffsssssssff....ffsssssssff...",
  "...ffffffffffff..ffffffffffff...",
  "..ffffftttfffff..ffffftttfffff..",
  "ff...ttt...ffffffffff...ttt...ff",
  "fff..ttt..ffffffffffff..ttt..fff",
  "....ttt..................ttt....",
  "....ttt..................ttt....",
  ".....tt..................tt.....",
  "................................",
  ...
  "tttkk0tttttttttttttttttttt0kkttt",
  "tttttttttttttttttttttttttttttttt",
  "tttttttttttttttttttttttttttttttt",
  "tttnnnnnnnnnnttttttnnnnnnnnnnttt",
  "ttnnnnnnnnnnnnttttnnnnnnnnnnnntt",
  ...
  "rrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr",
  "rrrggrrrrrrrrrrrrrrrrrrrrrrggrrr",
  "rrrgg0grrrrrrrrrrrrrrrrrrg0ggrrr",
  "rrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr",
  "rrrrrrnrrrrrrrrrrrrrrrrrrnrrrrrr",
  "rrrrrwrrwrrrrrrrrrrrrrrwrrwrrrrr",
  "rrrrkrrrrrrrrrrrrrrrrrrrrrrkrrrr",
  "rrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr",
  "rrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr",
  "rrggggrrrrrrrrrrrrrrrrrrrrggggrr",
  "rwwrrrrrrrrrrrrrrrrrrrrrrrrrrwwr",
  "wwwrrrrrrrrrrrrrrrrrrrrrrrrrrwww",
  "rrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr",
  "rrrrrrrnnrrrrrrrrrrrrrrnnrrrrrrr",
  "rrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr",
  "rrddddddddddddddddddddddddddddrr",
  "dddddddddddddddddddddddddddddddd",
  ...
  "ffffffffffffffffffffffffffffffff",
  "ffggggggggggggffffggggggggggggff",
  "gggggggggggggggggggggggggggggggg",
  "gggk0kggggggggggggggggggggk0kggg",
  "gggggggggggggggggggggggggggggggg",
  "ggggggnggggggggggggggggggngggggg",
  "ggggooooooooggggggggoooooooogggg",
  "gggooooooooooggggggooooooooooggg",
  "gggooooooooooggggggooooooooooggg",
  "ffgggoooooogggffffgggoooooogggff",
  "fffggggggggggffffffggggggggggfff",
  "ffffggggggggffffffffggggggggffff",
  "ffffffffffffffffffffffffffffffff",
  "ffggggggggggggffffggggggggggggff",
  "fggggggggggggggffggggggggggggggf",
  "gggggggggggggggggggggggggggggggg",
  "gggggggggggggggggggggggggggggggg",
  "ffggggggggggggffffggggggggggggff",
  "ffffffffffffffffffffffffffffffff",
  ...
  "tttttttttttttttttttttttttttttttt",
  "tttttttttttttttttttttttttttttttt",
  "tttgg0gttttttttttttttttttg0ggttt",
  "tttttttttttttttttttttttttttttttt",
  "tttttttttttttttttttttttttttttttt",
  "tttttwttttwttttttttttwttttwttttt",
  "tttttttttttttttttttttttttttttttt",
  "tttttttttttttttttttttttttttttttt",
  "tttttttttttttttttttttttttttttttt",
  "ttttwwwwwwwwttttttttwwwwwwwwtttt",
  "tttwwwwwwwwwwttttttwwwwwwwwwwttt",
  "ttwwwwwwwwwwwwttttwwwwwwwwwwwwtt",
  "ttggwwwwwwwwggttttggwwwwwwwwggtt",
  "tttttttttttttttttttttttttttttttt",
  "tttwwwwwwwwwwttttttwwwwwwwwwwttt",
  "ttttwwwwwwwwttttttttwwwwwwwwtttt",
  "tttttttttttttttttttttttttttttttt",
  "tttttttttttttttttttttttttttttttt",
  "tttttwwwwwwttttttttttwwwwwwttttt",
  "tttttttttttttttttttttttttttttttt",
  ".tttttttttttttt..tttttttttttttt.",
  "..tttttt................tttttt..",
  "..tttttt................tttttt..",
  ...
  "..tttttttttttt....tttttttttttt..",
  ".tttttttttttttt..tttttttttttttt.",
  "ttffffffffffffttttfffffffffffftt",
  "tfff0ffffffffff..ffffffffff0ffft",
  "tffffffffffffff..fffffffffffffft",
  "ttffffffffffffttttfffffffffffftt",
  "tttnnnnnnnnnnttttttnnnnnnnnnnttt",
  "tttttttttttttttttttttttttttttttt",
  "...tttbbbbttt......tttbbbbttt...",
  "..ttbbbbbbbbtt....ttbbbbbbbbtt..",
...
"vetala": [
  ...
  ".kkkkkppppppppphhpppppppppkkkkk.",
  ".kkkkkppppppphhpphhpppppppkkkkk.",
  ".kkkkkppppppyyppppyyppppppkkkkk.",
  ".kkkkkpppppppnppppnpppppppkkkkk.",
  ".kkkkkpppppnnppppppnnpppppkkkkk.",
  ".kkkkkpppppxppppppppxpppppkkkkk.",
  ".kkkkkppkkkkkkppppkkkkkkppkkkkk.",
  "..kkkkkkkkkkkkkkkkkkkkkkkkkkkk..",
  "...kkkkkkkkkkkkkkkkkkkkkkkkkk...",
  "....pppppppppppppppppppppppp....",
  "...kkddddddddddddddddddddddkk...",
  ".kkkkddddddddddddddddddddddkkkk.",
  "kkddddddddddddddddddddddddddddkk",
  "dddddddddddddddddddddddddddddddd",
  "dddgddddddddddddddddddddddddgddd",
  "dddddddddddddddddddddddddddddddd",
  "ddkkkkkkkkkkkkddddkkkkkkkkkkkkdd",
  "dddddddddddddddddddddddddddddddd",
  "dddddddddddddddddddddddddddddddd",
  ".dddddddddddddddddddddddddddddd.",
  "..dddddddddddddddddddddddddddd..",
...
const BESTIARY_DATA = [
  ...
  { id: 'vetala', name: 'เวตาลจอมขโมย', s: 'vetala', desc: 'วิญญาณสิงศพ ผิวซีดเผือด ตาเรืองเหลืองในเงามืด เคลื่อนที่รวดเร็วผิดปกติ ขโมยทรัพย์แล้วเผ่นหนี', tip: 'เคลื่อนที่ครั้งละ ๒ ช่อง ฆ่าให้ไวก่อนมันขโมยเงินแล้วหนี ฆ่าได้ไอเทมแต่เงินที่ขโมยไปจะไม่คืน' }
];
...
function openCursedAltarModal(ax, ay){
  ...
  html += '<p style="font-size:13px;color:var(--ink);margin:0 0 12px">เปลวเพลิงโลหิตกระหายการสังเวย เจ้าต้องยอมเสียสละ <b>เลือดสูงสุดและพลังกายบางส่วนอย่างถาวร</b> เพื่อแลกกับสิ่งตอบแทนหรือไม่?</p>';

  html += '<div style="display:flex;flex-direction:column;gap:8px;margin-bottom:14px">';
  html += '<button class="btn" id="btnSacWpn" ' + (canAffordWpn ? '' : 'disabled') + ' style="background:#8f2438;color:#fff;border-color:#e5482e">⚔ สังเวยรับ ศาสตราวุธเทวะ (เลือดสูงสุด -' + wpnMhpCost + ', ป้องกัน -' + wpnDefCost + ' ถาวร)</button>';
  html += '<button class="btn" id="btnSacGold" ' + (canAffordGold ? '' : 'disabled') + ' style="background:#5c2a3a;color:#f5c542;border-color:#f5c542">◉ สังเวยรับ ทองคำ ๑๕๐ ◉ (เลือดสูงสุด -' + goldMhpCost + ', ป้องกัน -' + goldDefCost + ' ถาวร)</button>';
  ...
  $('btnSacWpn').onclick = () => {
    if((player.mhp - wpnMhpCost) < 15) return;
    hide(ov);
    map[ay*W+ax] = 4; // มอดดับ
    flash = 0.6; shake = 6; sfx.hurt();
    player.mhp = Math.max(10, player.mhp - wpnMhpCost);
    ...
    msg('🩸 เลือดถูกสูบสังเวย! ได้รับ «' + godWpn.name + '» จากแท่นบูชาบาป! (เลือดสูงสุด -' + wpnMhpCost + ', ป้องกัน -' + wpnDefCost + ' ถาวร)', 'good');
    updateHud();
    if(player.hp <= 0) die();
  };

  $('btnSacGold').onclick = () => {
    if((player.mhp - goldMhpCost) < 15) return;
    hide(ov);
    map[ay*W+ax] = 4;
    flash = 0.6; shake = 6; sfx.hurt();
    player.mhp = Math.max(10, player.mhp - goldMhpCost);
...
function openBlackMarketModal(bx, by){
  ...
  // สังเวย "เลือดสูงสุด" (Max HP) ถาวร + แสตทบางส่วน แทนการเสียแค่เลือดปัจจุบันที่ฟื้นคืนได้ง่าย
  const itemsForSale = [
    { name: 'น้ำยาอมตะพญามาร', desc: 'ป้องกันดาเมจ ๑๐๐% นาน ๕ เทิร์น', costMhp: 6, costDef: 1, item: { t: 'elixir', elixirId: 'invuln', name: 'น้ำยาอมตะพญามาร', turns: 5, desc: 'อมตะไร้เทียมทาน ๕ เทิร์น', r: 'mythic', lore: 'โอสถโลหิตอสูร ป้องกันความเสียหายทุกชนิด' } },
    { name: 'คัมภีร์ชำระคำสาป', desc: 'ล้างผลเสียอุปกรณ์ต้องสาปทิ้งอย่างถาวร', costMhp: 3, costDef: 0, item: { t: 'scroll_tac', scrollId: 'curse', name: 'คัมภีร์ชำระคำสาป', desc: 'ล้างผลเสียอุปกรณ์ต้องสาป', r: 'legendary', lore: 'ชำระไออสูร' } },
    { name: 'มณีโมกษะ', desc: 'ชุบชีวิตฟื้นคืนชีพ ๑ ครั้งเมื่อเลือดหมด', costMhp: 10, costDef: 2, item: { t: 'relic', id: 'ankh', name: 'มณีโมกษะ', icon: '💎', r: 'mythic', desc: 'ชุบชีวิตฟื้นคืนชีพ ๑ ครั้ง', lore: 'มณีฉุดวิญญาณจากยมโลก' } },
    { name: 'ขรรค์เพชรจุติ +๓', desc: 'อาวุธเทวะระดับ ๔ ตีบวก +๓ ทันที', costMhp: 8, costDef: 1, item: genW(4) }
  ];
  ...
  html += '<p style="font-size:13px;color:var(--ink);margin:0 0 12px">“ที่นี่ไม่รับเศษเหรียญทอง… เราต้องการเลือดสูงสุดและพลังกายของเจ้าอย่างถาวรแลกกับของวิเศษ!”</p>';

  html += '<div style="display:flex;flex-direction:column;gap:8px;text-align:left;margin-bottom:14px">';
  itemsForSale.forEach((prod, idx) => {
    const canAfford = (player.mhp - prod.costMhp) >= 15;
    ...
    html += '<button class="mini-btn" style="background:#8f2438;color:#fff;border-color:#e5482e" ' + (canAfford ? '' : 'disabled') + ' onclick="buyBlackMarketItem(' + idx + ',' + bx + ',' + by + ')">เลือดสูงสุด -' + prod.costMhp + (prod.costDef ? ', ป้องกัน -' + prod.costDef : '') + ' ถาวร</button>';
    html += '</div>';
  });
  html += '</div>';
...
function buyBlackMarketItem(idx, bx, by){
  ...
  if(!prod || (player.mhp - prod.costMhp) < 15) return;
  player.mhp = Math.max(10, player.mhp - prod.costMhp);
  player.def = Math.max(0, player.def - (prod.costDef || 0));
  player.hp = Math.min(player.hp, player.mhp);
  player.sin = (player.sin || 0) + 1;
  flash = 0.6; shake = 6; sfx.hurt();
  ...
  msg('🩸 เจ้าสละเลือดสูงสุด -' + prod.costMhp + (prod.costDef ? ' และป้องกัน -' + prod.costDef : '') + ' ถาวร ซื้อ «' + prod.name + '» จากตลาดมืด! (+๑ บาป)', 'good');
  sfx.level();
  hide($('blackMarketOv'));
  updateHud();
  if(player.hp <= 0) die();
...
function killFoe(e){
  ...
  checkLevel();
    ...
    console.error('killFoe: เกิดข้อผิดพลาดระหว่างคำนวณรางวัล (ศัตรูถูกลบออกจากเกมแล้วอย่างปลอดภัย):', err);
  }
}
function checkLevel(){
  let up=false;
...
function enemiesAct(){
  for(const e of enemies.slice()){
    ...
    if(dist===1){
      ...
      // ถ้าเกราะหนาม/สวนกลับของผู้เล่นฆ่า e ไปแล้วระหว่าง hurtPlayer (ถูกลบออกจาก enemies แล้ว)
      // ต้องหยุดไม่ให้ e ทำอะไรต่อในเทิร์นนี้ (เช่น ดูดเลือดฟื้นฟูตัวเองทำให้ hp เด้งกลับมา >0 ทั้งที่ตายไปแล้ว)
      if(e.hp<=0) continue;
    ...
    if(e.thief && !e.hasStolen && player.gold > 0){
      ...
      floats.push({x:player.x, y:player.y, t:'ถูกขโมย -◉'+stolen, c:'#f5c542', life:1.4});
      msg('👻 ' + e.name + 'ล้วงขโมยเงิน ◉' + stolen + ' แล้วเผ่นหนีทันที!', 'warn');
    }
    ...
    // 👻 เวตาลจอมขโมย: ถ้าขโมยเงินไปแล้ว ให้วิ่งหนีสวนทางแทนไล่ตาม
    const fleeMode = e.thief && e.hasStolen;
    const sx=fleeMode ? -Math.sign(dx) : Math.sign(dx);
    const sy=fleeMode ? -Math.sign(dy) : Math.sign(dy);
    const order=Math.abs(dx)>Math.abs(dy)?[[sx,0],[0,sy]]:[[0,sy],[sx,0]];
    const moveSteps = e.moveSpeed || 1; // มอนบางชนิด (เช่น เวตาล) เคลื่อนที่ได้มากกว่า ๑ ช่อง/เทิร์น
...
function die(){
  // ก่อนจบเกมจริง เสนอให้จ่ายทองไถ่ชีวิตก่อน ถ้ามีเงินพอ (ค่าไถ่เพิ่มเป็น ๒ เท่าทุกครั้งที่ใช้ในรอบเดียวกัน)
  const reviveCost = player.reviveCost || 100;
  if(player.gold >= reviveCost){
    offerRevive(reviveCost);
    return;
  }
  finalizeDeath();
}
...
function offerRevive(cost){
  ...
  let html = '<div class="panel" style="max-width:380px;border-color:var(--gold);box-shadow:0 0 28px rgba(245,197,66,.5);text-align:center">';
  html += '<div class="deva" style="color:var(--gold)">पुनर्जीवन</div>';
  html += '<h2 style="font-family:Chakra Petch;color:var(--gold);margin:2px 0 6px;font-size:22px">💰 จ่ายทองไถ่ชีวิต?</h2>';
  html += '<p style="font-size:13px;color:var(--ink);margin:0 0 14px">เจ้าล้มลงสิ้นลมปราณ… แต่ยังมีทางกลับมาได้ด้วยเงินทอง <b class="gold">◉' + cost + '</b><br><small class="dim">(ค่าไถ่จะเพิ่มเป็น ๒ เท่าหากใช้อีกครั้งในรอบนี้)</small></p>';
  html += '<div style="display:flex;flex-direction:column;gap:8px">';
  html += '<button class="btn" id="btnDoRevive" style="background:#f5c542;color:#1b0c16;border-color:#f5c542">💰 จ่าย ◉' + cost + ' ฟื้นคืนชีพ</button>';
  html += '<button class="btn ghost" id="btnDeclineRevive">ยอมรับความตาย</button>';
  html += '</div></div>';
  ov.innerHTML = html;
  show(ov);
...
function render(){
  ...
  for(const e of enemies){
    ...
    if(e.flash>0){
      ...
      // รองรับสไปรท์มอนสเตอร์ความละเอียดสูงกว่าปกติผ่าน SPR_SIZE (บอสวาดใหญ่ได้มากกว่ามอนทั่วไปเล็กน้อย)
      const eSprSize = SPR_SIZE[e.sprite] || 16;
      const eSprDraw = Math.min(eSprSize, e.boss ? 30 : 20);
      const eSprDX = (16 - eSprDraw) / 2;
      const eSprDY = 16 - eSprDraw;
      drawSpr(e.sprite, ex + eSprDX, ey + eBob + eSprDY, eSprDraw, eSprDraw, flipE, eSquash);
    }
  ...
  if(player.hp>0){
    ...
    // หมายเหตุ: ข้อมูลต้นฉบับอาจละเอียดถึง 32x32 (คมชัดในเมนู/หน้าสเตตัส)
    // แต่ในดันเจี้ยนจำกัดขนาดที่วาดจริงไว้ไม่เกิน 22px กันตัวละครดูใหญ่เกินช่อง 16px
    const pSprSize = SPR_SIZE[player.sprite] || 16;
    const pSprDraw = Math.min(pSprSize, 22);
    const pSprDX = (16 - pSprDraw) / 2; // จัดกึ่งกลางแนวนอนเทียบกับช่องปกติ 16px
    const pSprDY = 16 - pSprDraw;       // ยึดเท้าไว้ที่ขอบล่างช่องเดิม ส่วนหัว/ไหล่ที่ใหญ่ขึ้นล้นขึ้นด้านบน
    drawSpr(player.sprite, px + pSprDX, py + pBob + pSprDY, pSprDraw, pSprDraw, flipP, 0);
